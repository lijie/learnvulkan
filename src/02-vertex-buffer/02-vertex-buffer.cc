...
class VertexBufferApp {
 ...
 private:
  ...
  static void FramebufferResizeCallback(GLFWwindow* window, int width,
                                        int height) {
    auto app =
        reinterpret_cast<VertexBufferApp*>(glfwGetWindowUserPointer(window));
  ...
  void CreateGraphicsPipeline() {
    auto vertShaderCode = ReadFile("02-vert.spv");
    auto fragShaderCode = ReadFile("02-frag.spv");
  ...
  void DrawFrame() {
    ...
    RecordCommandBuffer(cmd_buffer.command_buffer, imageIndex);
  ...
  void CreateVertexBuffer() {
    ...
    if (vkCreateBuffer(device_, &bufferInfo, nullptr, &vertex_buffer_) !=
        VK_SUCCESS) {
