...
class VulkanPipelineBuilder final {
 public:
  ...
  VulkanPipelineBuilder& dynamicStates(
  ...
  VulkanPipelineBuilder& shaderStages(
  ...
  VulkanPipelineBuilder& vertexInputState(
  ...
  VkResult build(VkDevice device, VkPipelineCache pipelineCache,
...
class VulkanComputePipelineBuilder final {
 public:
  ...
  VulkanComputePipelineBuilder& shaderStage(
